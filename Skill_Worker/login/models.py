...
def create_worker(info):
    Worker.objects.create(first_name=info['first_name'],last_name=info['last_name'],email=info['email'],password=info['password'],birthdate=convert_str_date(info['birthdate']))
